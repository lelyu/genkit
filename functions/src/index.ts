...
const getAllItems = ai.defineTool(
	{
		...
		outputSchema: z.array(
			z.object({
				...
				dateCreated: z
					.string()
					.describe('The date the' + ' item was created'),
				description: z
					.string()
					.optional()
				...
				dateModified: z
					.string()
					.optional()
					.describe('The date the item ' + 'was modified'),
			})
		),
	},
	async ({ userId }) => {
...
const getAllLists = ai.defineTool(
	{
		...
		outputSchema: z.array(
			z.object({
				...
				dateCreated: z
					.string()
					.describe('The date the' + ' list was created'),
				description: z
					.string()
					.optional()
					.describe('The description ' + 'of the list'),
				dateModified: z
					.string()
					.optional()
					.describe('The date the list ' + 'was modified'),
			})
		),
	},
	async ({ userId }) => {
...
const getAllFolders = ai.defineTool(
	{
		...
		outputSchema: z.array(
			z.object({
				...
				dateCreated: z
					.string()
					.describe('The date the' + ' folder was created'),
				description: z
					.string()
					.optional()
				...
				dateModified: z
					.string()
					.optional()
					.describe('The date the folder ' + 'was modified'),
			})
		),
	},
	async ({ userId }) => {
 ...
 */
async function generateResponseFromGemini(data: {
	prompt: string
	userId: string
}): Promise<string> {
